...
//     this.Then(/^I see logo$/, async () => {
//         //Get element to work with
//         let onlinerLogo:ElementFinder = await element(by.css(".onliner_logo"));

//         //100% CORRECT WAY OF WAITING FOR ELEMENT
//         await browser.wait(ExpectedConditions.visibilityOf(onlinerLogo), defaultTimeout, "Onliner Logo wasn't loaded or has incorrect locator");
//     });
